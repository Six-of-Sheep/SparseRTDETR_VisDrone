"""Execute exactly one frozen seed2 historical-control completion invocation."""
...
def main(argv=None):
    ...
    try:
        ...
        from sparse_rtdetr.baseline.training_v2b_seed2_completion_worker import run_seed2_completion_worker
        result = run_seed2_completion_worker(contract, contract_reference=reference)
