#!/usr/bin/env python3
"""Read-only verifier for the versioned REV1 smoke launch surface (execution revision 012)."""
...
EXECUTION_SOURCE_ID = "v2b-exec-012"
EXECUTION_CONTRACT_ID = "v2b-execution-contract-012"
