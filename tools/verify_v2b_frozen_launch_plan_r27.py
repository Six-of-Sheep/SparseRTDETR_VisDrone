#!/usr/bin/env python3
"""Strict read-only verifier for the REV1 bridge-027 frozen launch plan."""
...
AUTH_ID = "smoke-v2b-rev1-s2-r896-bridge-027"
PLAN_ID = "P3-V2B-REV1-FROZEN-LAUNCH-BRIDGE027"
BRIDGE_SHA = "3d33e1ddc598e21180cb193665f785803ee26af3829162b8bcfc70c93858b4ab"
BINDING_SHA = "211be3dc210c8d644e18465c8c50df6369b64160212f9fc2ac4d37a993f550e1"
MANIFEST_SHA = "22921fb4ad27050e2415d7fc78d9dc286b09f4d7f36e0dc1250b49c91317166c"
...
def identity_view(plan: dict[str,Any]) -> dict[str,Any]:
    ...
    for field in ("exact_argv", "controller_argv"):
