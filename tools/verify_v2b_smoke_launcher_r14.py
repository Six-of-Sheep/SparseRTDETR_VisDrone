#!/usr/bin/env python3
"""Read-only verifier for the versioned REV1 smoke launch surface (execution revision 014)."""
...
EXECUTION_SOURCE_ID = "v2b-exec-014"
EXECUTION_CONTRACT_ID = "v2b-execution-contract-014"
