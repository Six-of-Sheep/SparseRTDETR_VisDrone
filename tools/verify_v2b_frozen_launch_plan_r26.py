#!/usr/bin/env python3
"""Strict read-only verifier for the REV1 bridge-026 frozen launch plan."""
...
AUTH_ID = "smoke-v2b-rev1-s2-r896-bridge-026"
PLAN_ID = "P3-V2B-REV1-FROZEN-LAUNCH-BRIDGE026"
