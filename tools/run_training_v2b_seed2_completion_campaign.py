#!/usr/bin/env python3
"""Execute one immutable seed2 missing-cell campaign; no resume, retry or extension."""
import argparse
import json
...
from sparse_rtdetr.baseline.training_v2b_seed2_completion_campaign import _json, run_seed2_completion_campaign
...
def main():
    ...
    result = run_seed2_completion_campaign(freeze, freeze_reference=reference)
